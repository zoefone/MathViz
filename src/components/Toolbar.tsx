...
export function Toolbar() {
  ...
  return (
    ...
    >
      ...
      <div className="flex items-center gap-1.5">
        <IconBtn title={t(locale, 'exportPng')} onClick={() => exportBoardPng()}>
        ...
        <IconBtn title={t(locale, 'exportSvg')} onClick={() => exportBoardSvg()}>
        ...
        <IconBtn title={t(locale, 'saveMvz')} onClick={() => saveMvzFile(doc)}>
        ...
        <IconBtn title={t(locale, 'share')} onClick={() => shareMvzUrl(doc)}>
